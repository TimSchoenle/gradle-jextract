...
plugins {
    java
    id("de.timscho.jextract") version "0.3.20"
}
...
Coordinates `de.timscho:gradle-jextract`, version `0.3.20`, plugin id `de.timscho.jextract`. Add
...
buildscript {
    ...
    dependencies {
        classpath("de.timscho:gradle-jextract:0.3.20")
    }
}
